...
- **Witness phase D (crash)** — the experimental face of L5: both machines halt at random
  ...
  that must be caught in 100% of cases: `crash_emit_after_halt` (in its sneaky variant the
